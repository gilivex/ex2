...
class DWGraph_DSTest {
    ...
    void getNodes() {
        ...
        g.addNode(new Node_DS(0));
        g.addNode(new Node_DS(1));

        node_data n = g.getNode(2);
        assertNull(n);
    }
...
//        g.addNode(new Node_DS(0));
//        g.addNode(new Node_DS(1));
//        g.addNode(new Node_DS(2));
//        g.addNode(new Node_DS(3));
//        g.connect(0,1,1);
//        g.connect(0,2,2);
//        g.connect(0,3,3);
//        g.connect(0,1,1);
